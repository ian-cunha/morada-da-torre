    ...
    <div>
      ...
      <form name="formContato" onSubmit={handleSubmit}>
        <fieldset>
          ...
          <button value={4500} onClick={(e) => setEmpreendimento(e.target.value)} type="submit" className="btn bg-primary btn-lg text-light w-100 mt-4">Quero saber mais! <i className="bi bi-arrow-right-circle"></i></button>
